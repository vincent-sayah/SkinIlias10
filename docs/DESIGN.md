...
- La version `1.1.2` ne contient plus aucun override HTML UI. C'est volontaire : les templates HTML de carte et de layout peuvent modifier la bascule native liste/tuile et casser le positionnement des panneaux ILIAS.
