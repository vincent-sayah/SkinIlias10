...
- La version `1.1.10` place le logo eForm Marine dans le bandeau haut gauche via `HeaderIcon.svg` et une version PNG horizontale optimisee pour l'en-tete.
...
- Les titres principaux d'objet et les titres de tuiles recoivent automatiquement un point rouge final.
- Le footer affiche le bloc-marque du ministere des Armees depuis `images/logo/logo-ministere-armees-anciens-combattants-ilias.svg`.
