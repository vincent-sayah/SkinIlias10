...
La version `1.1.3` garde la structure native ILIAS et concentre la personnalisation sur le CSS et les icones : logo eForm Marine dans le bandeau haut gauche, barre laterale bleu marine avec accent rouge, barre haute sobre, fil d'Ariane, onglets, tuiles, cartes repository, menus d'action non tronques et icones d'objets sans fond colore en vue liste.
